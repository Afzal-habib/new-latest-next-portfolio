...
export function ProfessionalLoader({
  ...
  return (
    <div className={`flex flex-col items-center justify-center gap-5${className ? ` ${className}` : ""}`}>
...
export function CompactLoader({ className }: { className?: string }) {
  return (
    <div className={`relative w-8 h-8${className ? ` ${className}` : ""}`}>

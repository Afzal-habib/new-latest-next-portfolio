...
The focus is dependable booking flows, clear pricing and itinerary presentation, and operational safety—retries, timeouts, structured logging, and strict separation of test vs production credentials across integrations.`,
  ...
  },
  {
    ...
    shortDescription: 'Car sale & rental marketplace for listing cars for sale or rent and customer bookings',
    description:
    ...
    contributions: [
      ...
      'Designed PostgreSQL schema and indexes for high-traffic marketplace queries',
    ...
    featured: true,
    order: -1,
    tags: ['Next.js', 'NestJS', 'PostgreSQL', 'TypeScript', 'Full-Stack', 'Automotive'],
    isOpenSource: false,
  },
  {
    id: '14',
